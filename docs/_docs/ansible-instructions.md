...
- Modify cluster global variables
  ...
  Edit [`kubernetes/clusters/prod/config/cluster-settings.yaml`]({{ site.git_edit_address }}/kubernetes/clusters/prod/config/cluster-settings.yaml) to use your own configuration. Own DNS domain, External Services DNS names, etc.
